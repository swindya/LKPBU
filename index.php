...
{
?>
<body background="./images/raja4.jpg">
<?php
}
else
{
?>
<body background="./images/BaliSeaTemple.jpg">
<?php
}
?>
...
?>
		<font color="red" size="1">Username/password is not found. Try again</font>
<?php	
		}
		elseif ($_SESSION['statuslogin'] == 7) {
?>
		<font color="red" size="1">Session expired</font>
<?php
		}
		else {
		}
...
<DIV align="center">
	...
	<div class="login_side">
		...
		<form action="lkpbumain.php" method="post" name="logForm" id="logForm" >
