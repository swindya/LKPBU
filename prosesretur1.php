...
if (!isset($_POST["datepicker-example1a"])) {
	...
	$tglproses=$_POST["datepicker-example1a"];
//-----------------------------------------
...
$sql = "SELECT * FROM " . $returtable . " WHERE sppd='" . $sppd . "' AND bank='" . $banktujuan . "' AND nominal='" . $nominal . 
		"' AND norekdb='" . $norekbaru . "';"; 
//echo $noret . "--" . $sql . "<br>";
$row_cnt = 0;
$ii = 0;
...
if ($ii == 0) {
	if ($noret ==1) {
		$sql8 = "INSERT INTO returtransfer1 (perusahaanID, tahun, returtransferID, batch, tgl, nama, sppd, nosuratdatindo, nosuratbni, atasnama, bank, " .
				"cabang, norekkd, nominal, createduser, createddate) VALUES(" . $perushid . "," . $tahun . "," . $returid . "," . $batch . ",'" . $tglku . "','" . $nama . "','" .
				$sppd . "','" . $suratdatindo . "','" . $suratbni . "','" . $atasnamarek . "','" . $banktujuan . "','" . $cabang . "','" . 
				$norekbaru . "','" . $nominal . "'," . $userid . ",'" . $date . "');";
		$statusiki = 1;
	}
	else if ($noret == 2) {
		$sql8 = "INSERT INTO returtransfer2 (perusahaanID, tahun, returtransferID, batch, tgl, nama, sppd, nosuratdatindo, nosuratbni, atasnama, bank, " .
				"cabang, norekkd, nominal, createduser, createddate) VALUES(" . $perushid . "," . $tahun . "," . $returid . "," . $batch . ",'" . $tglku . "','" . $nama . "','" .
				$sppd . "','" . $suratdatindo . "','" . $suratbni . "','" . $atasnamarek . "','" . $banktujuan . "','" . $cabang . "','" . 
				$norekbaru . "','" . $nominal . "'," . $userid . ",'" . $date . "');";
		$statusiki = 2;
		...
		$sql8 = "INSERT INTO returtransfer3 (perusahaanID, tahun, returtransferID, batch, tgl, nama, sppd, nosuratdatindo, nosuratbni, atasnama, bank, " .
				"cabang, norekkd, nominal, createduser, createddate) VALUES(" . $perushid . "," . $tahun . "," . $returid . "," . $batch . ",'" . $tglku . "','" . $nama . "','" .
				$sppd . "','" . $suratdatindo . "','" . $suratbni . "','" . $atasnamarek . "','" . $banktujuan . "','" . $cabang . "','" . 
				$norekbaru . "','" . $nominal . "'," . $userid . ",'" . $date . "');";
		$statusiki = 3;
		...
		$sql8 = "INSERT INTO returtransfer4 (perusahaanID, tahun, returtransferID, batch, tgl, nama, sppd, nosuratdatindo, nosuratbni, atasnama, bank, " .
				"cabang, norekkd, nominal, createduser, createddate) VALUES(" . $perushid . "," . $tahun . "," . $returid . "," . $batch . ",'" . $tglku . "','" . $nama . "','" .
				$sppd . "','" . $suratdatindo . "','" . $suratbni . "','" . $atasnamarek . "','" . $banktujuan . "','" . $cabang . "','" . 
				$norekbaru . "','" . $nominal . "'," . $userid . ",'" . $date . "');";
		$statusiki = 4;
		...
		$sql8 = "INSERT INTO returtransfer5 (perusahaanID, tahun, returtransferID, batch, tgl, nama, sppd, nosuratdatindo, nosuratbni, atasnama, bank, " .
				"cabang, norekkd, nominal, createduser, createddate) VALUES(" . $perushid . "," . $tahun . "," . $returid . "," . $batch . ",'" . $tglku . "','" . $nama . "','" .
				$sppd . "','" . $suratdatindo . "','" . $suratbni . "','" . $atasnamarek . "','" . $banktujuan . "','" . $cabang . "','" . 
				$norekbaru . "','" . $nominal . "'," . $userid . ",'" . $date . "');";
		$statusiki = 5;
