...
function hapusdatatelkom() {
	...
	{	
		...
		if (tahun=="" || tahun ==null || batch=="" || batch==null)
		{
			...
			var linkget = "delawaltelkom.php?perusid=" + perusid + "&userid=" + userid + "&tahun=" + tahun + "&batch=" + batch;
...
function hapusdatabni() {
	...
	{	
		...
		if (tahun=="" || tahun ==null || batch=="" || batch==null)
		{
			...
			var linkget = "delawalbni.php?perusid=" + perusid + "&userid=" + userid + "&tahun=" + tahun + "&batch=" + batch;
			xmlhttp.open("GET", linkget,true);
			xmlhttp.send();
		//alert("Data sudah di-update");
		}
...
function hapusdatagg() {
	...
	{	
		...
		if (tahun=="" || tahun ==null || batch=="" || batch==null)
		{
			...
			var linkget = "delawalgg.php?perusid=" + perusid + "&userid=" + userid + "&tahun=" + tahun + "&batch=" + batch;
			xmlhttp.open("GET", linkget,true);
			xmlhttp.send();
		//alert("Data sudah di-update");
		}
...
if (!isset($_POST["batch"])) {
	...
	$batch = $_POST["batch"];
//----------------------------------------------------
if (!isset($_GET["statusupload"])) {
	$statusupload = 0;
}
else
	$statusupload = $_GET["statusupload"];
//----------------------------------------------------
