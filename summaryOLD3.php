	...
	<table align="right" style="text-align: right; margin-left: auto; margin-right: auto; margin-top: 0px; height: 30px;" width="220px" border="0" cellpadding="2" cellspacing="0">
          <tr style="vertical-align: middle;" height="30px"> 
            <td style="padding-left: 0px; text-align: left; font-size: 12; width: 20px">
				<span title="User Login"><a href="" target=""><img src="./img/user3a.png" /></a></span>
			</td>
            <td style="vertical-align: middle; padding-left: 0px; text-align: left; font-size: 12; width: 200px">
				<p><font face="arial" color="blue">&nbsp;</font>
				<i><font face="arial" color="blue">
				<!--span title="Setting"><a href="" target=""><img src="./img/user1a.png" /></a></span-->
