...
//alert(document.getElementsByName("statusview")[0].value);
		document.forms["viewbond"].submit();
		return true;
	}
</script>
<script>
...
<table style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: auto;" width="1100px" border="0" cellspacing="0" cellpadding="0">
	...
	<form name="myupload" id="myupload" action="uploaddatadailygo.php" method="post" enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr height="30px">
					<td style="padding-left: 10px; text-align: left; font-size: 12; width: 100px">
						<input name="uploadfiledaily" id="uploadfiledaily" type="file">
					</td>
...
<br>
<form name="viewbond" id="viewbond" action="" method="post">
	<table align="left" style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: auto;" width="500px" border="0" cellspacing="0" cellpadding="0">
		...
		<tr height="10px">
			...
			<td>
				<input type="hidden" id="sview" name="sview" value="1">
			</td>
		</tr>
		<tr height="20px">
			<td style="padding-left: 10px; padding-top: auto;text-align: left; font-size: 12">
				<div class="main-wrapper">
						...
						<a href="" class="small button orange" onclick="viewdata(); return false;">View</a>
				</div>
			</td>
...
<?php
$query = "SELECT * FROM bond WHERE (tglcreate BETWEEN '" . $tgl1 . "' AND '" . $tgl2 . "');";
$row_cnt = 0;
$jmldata = 0;
$result = mysqli_query($link, $query);
if ($result) {
...
if ($row_cnt>0) {
	...
	while ($row = mysqli_fetch_array ($result, MYSQLI_ASSOC)) {
		...
		$type[$i] = $row['type'];
		$subtype[$i] = $row['subtype'];
		$localcode[$i] = $row['localcode'];
		$isincode[$i] = $row['isincode'];
		$cur[$i] = $row['cur'];
	}
	$jmldata = $i;
}
...
{
?>
	<table align="left" style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: 0px;" width="920px" border="0" cellpadding="0" cellspacing="0">
		<tr height="40px"> 
            <td style="padding-left: auto; text-align: center; font-size: 12;  width: 30px;">
				<b><i><font face="calibri" size="2" color="black">NO</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 90px">
				<b><i><font face="calibri" size="2" color="black">SHORT NAME</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 250px">
				<b><i><font face="calibri" size="2" color="black">DESCRIPTION</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 120px">
				<b><i><font face="calibri" size="2" color="black">TYPE</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 110px">
				<b><i><font face="calibri" size="2" color="black">SUB TYPE</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 80px">
				<b><i><font face="calibri" size="2" color="black">LOCALCODE</font></i></b>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: center; font-size: 12; width: 140px">
				<b><i><font face="calibri" size="2" color="black">ISINCODE</font></i></b>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: center; font-size: 12; width: 90px">
				<b><i><font face="calibri" size="2" color="black">CURRENCY</font></i></b>
			</td>
        </tr>
<?php
...
?>
		<tr height="22px"> 
            ...
            <td style="padding-left: auto; text-align: center;" valign="top">
				<font face="calibri" size="2" color="black"><?php echo $shortname[$j];?></font>
			</td>
            <td style="padding-left: auto; text-align: left;" valign="top">
				<font face="calibri" size="2" color="black"><?php echo $description[$j];?></font>
			</td>
            <td style="padding-left: auto; text-align: center;" valign="top">
				<font face="calibri" size="2" color="black"><?php echo $type[$j];?></font>
			</td>
            <td style="padding-left: auto; text-align: center;" valign="top">
				<font face="calibri" size="2" color="black"><?php echo $subtype[$j];?></font>
			</td>
            <td style="padding-left: auto; text-align: center;" valign="top">
				<font face="calibri" size="2" color="black"><?php echo $localcode[$j];?></font>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: center;" valign="top">
				<font face="calibri" size="2" color="black"><?php echo $isincode[$j];?></font>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: center;" valign="top">
				<font face="calibri" size="2" color="black"><?php echo $cur[$j];?></font>
			</td>
        </tr>
<?php
		}
