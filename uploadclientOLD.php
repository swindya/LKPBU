...
<?php
$query = "SELECT * FROM dailyact WHERE (setdate BETWEEN '" . $tgl1 . "' AND '" . $tgl2 . "');";
$row_cnt = 0;
$jmldata = 0;
$result = mysqli_query($link, $query);
if ($result) {
...
if ($row_cnt>0) {
	...
	while ($row = mysqli_fetch_array ($result, MYSQLI_ASSOC)) {
		...
		$secacc[$i] = $row['securityacc'];
		$tradedate[$i] = $row['tradedate'];
		$setdate[$i] = $row['setdate'];
		$qty[$i] = $row['qty'];
		$status[$i] = $row['status'];
		$acc[$i] = $row['acc'];
	}
	...
	<table align="left" style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: 0px;" width="850px" border="0" cellpadding="0" cellspacing="0">
		<tr height="40px"> 
            ...
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 80px">
				<b><i><font face="calibri" size="2" color="black">ORDER ID</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 170px">
				<b><i><font face="calibri" size="2" color="black">SECURITY ACC</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 110px">
				<b><i><font face="calibri" size="2" color="black">TRADE DATE</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 110px">
				<b><i><font face="calibri" size="2" color="black">SETTLEMENT DATE</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 120px">
				<b><i><font face="calibri" size="2" color="black">QTY</font></i></b>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: center; font-size: 12; width: 100px">
				<b><i><font face="calibri" size="2" color="black">STATUS</font></i></b>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: center; font-size: 12; width: 120px">
				<b><i><font face="calibri" size="2" color="black">ACCOUNT</font></i></b>
			</td>
        </tr>
<?php
...
?>
		<tr height="22px"> 
            ...
            <td style="padding-left: auto; text-align: left;">
				<font face="calibri" size="2" color="black"><?php echo $orderid[$j];?></font>
			</td>
            <td style="padding-left: auto; text-align: left;">
				<font face="calibri" size="2" color="black"><?php echo $secacc[$j];?></font>
			</td>
            <td style="padding-left: auto; text-align: center;">
				<font face="calibri" size="2" color="black"><?php echo $tradedate[$j];?></font>
			</td>
            <td style="padding-left: auto; text-align: center;">
				<font face="calibri" size="2" color="black"><?php echo $setdate[$j];?></font>
			</td>
            <td style="padding-left: auto; text-align: right;">
				<font face="calibri" size="2" color="black"><?php echo number_format($qty[$j]);?></font>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: center;">
				<font face="calibri" size="2" color="black"><?php echo $status[$j];?></font>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: center;">
				<font face="calibri" size="2" color="black"><?php echo $acc[$j];?></font>
			</td>
        </tr>
<?php
		}
