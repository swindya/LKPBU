...
<?php
$query = "SELECT * FROM maindata WHERE (tgl BETWEEN '" . $tgl1 . "' AND '" . $tgl2 . "') ORDER BY tgl DESC;";
$row_cnt = 0;
$jmldata = 0;
$totalholding = 0;
$aa = 0;
	...
	<table align="left" style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: 0px;" width="850px" border="0" cellpadding="0" cellspacing="0">
		<tr height="40px">
            ...
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 150px">
				<b><i><u><font face="calibri" size="2" color="black">TOTAL HOLDING</font></u></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 450px">
...
?>
		<tr height="22px"> 
            ...
            <td style="padding-left: auto; text-align: right;">
				<font face="calibri" size="2" color="black"><?php echo number_format($totholding[$j]);?></font>
			</td>
