...
<table style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: auto;" width="1100px" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td style="vertical-align: top; padding-left: auto; padding-top: 0; text-align: left; font-size: 12; width: 1100px">
		<form name="myupload" id="myupload" action="uploadpasarmodalgo.php" method="post" enctype="multipart/form-data">
			<table style="text-align: left; margin-left: 10px; margin-right: auto; margin-top: auto;" width="1100px" border="0" cellspacing="0" cellpadding="0">
				<thead>
					<tr height="30px">
						<td colspan="2" style="padding-left: 10px; padding-top: auto; text-align: left; font-size: 11; width: 1100px">
				...
				<tbody>
					...
					<tr height="30px">
						<td style="padding-left: 40px; padding-top: 0px; text-align: left; font-size: 0.9em; width: 300px">
							<font face="arial" color="black">
								Raw File, Statis Efek, Securities Type :
							</font>
						</td>
						<td style="padding-left: 10px; text-align: left; font-size: 12; width: 400px">
							<div>
								<div class="formRow">
					...
					<tr height="50px">
						<td colspan="3" style="padding-left: 10px; text-align: left; font-size: 12"></td>
					</tr>
					<tr height="30px">
						<td style="padding-left: 10px; text-align: left;">
							<a href="" class="medium button orange" onclick="uploaddata(); return false;">Upload</a>
						</td>
						<td colspan="2" style="padding-left: auto; text-align: left;">
...
?>
	...
	<table align="left" style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: 0px;" width="1100px" border="0" cellpadding="0" cellspacing="0">
		<tr height="60px">
            <td colspan="3" style="padding-left: auto; text-align: center; font-size: 12;  width: 1100px;">
			</td>
		</tr>
		<tr height="30px">
            <td colspan="3" style="padding-left: 20px; text-align: left; font-size: 1.2em">
				<b><u><font face="calibri" color="black">RINGKASAN UPLOAD</font></u></b>
			</td>
		</tr>
		<tr height="30px">
            <td colspan="3" style="padding-left: auto; text-align: center; font-size: 12;">
			</td>
		</tr>
<?php
		for ($a = 0; $a < $jmlada; $a++)
...
?>
		<tr height="30px">
            <td style="padding-left: 40px; text-align: left; font-size: 1.2em;">
				<font face="calibri" color="black"><?php echo $outputinfoarr[$a];?></font>
			</td>
		</tr>
