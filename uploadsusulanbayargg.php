...
//---------------------------------------------------------------------------------------------------
	...
	$sql1 = "UPDATE gudanggaramsusulan SET tglbayar='" . $tgl . "', statustransfer=1 WHERE ID=" . $susulid . ";";
echo $sql1 . "<br>";
	$result = mysqli_query($link,$sql1);
	
	$sql1 = "UPDATE gudanggaram SET statusbayar=1 WHERE ID=" . $susulid . ";";
	$result = mysqli_query($link,$sql1);
	
// Log trail -------------------------------
	$dataku = "GUDANGGARAMSUSULANBAYAR|tgltrf:" . $tgl . "|susulanid:" . $susulid;
