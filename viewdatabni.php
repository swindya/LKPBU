...
if ($cari=="none" || strlen($cari)<2)
	...
	//$caristr = " AND (sppd LIKE '%" . strtoupper($cari) . "%' OR nama1 LIKE '%" . strtoupper($cari) . "%' OR noacc1 LIKE '%" . strtoupper($cari) . 
	//			"%' OR namabank LIKE '%" . strtoupper($cari) . "%')";
...
$sql0 = "SELECT * FROM bni WHERE (perusahaanID=" . $perushid . $tahunbukustr . $batchstr . $caristr . $bayarstr . ");";
...
if ($jmlrow==0) {
	...
	while ($row = mysqli_fetch_array ($result, MYSQLI_ASSOC)) {
		...
		$kotai[$i] = $row['kota'];
		$seqnoi[$i] = $row['seqno'];
		$noacc1i[$i] = $row['noacc1'];
		$paymentcoi[$i] = $row['paymentco'];
...
$filename = './REPORT/REPORT_BNI' . $tahun . "_" . $batch . '.xls';
...
// Change the file
		...
		$objPHPExcel->getActiveSheet()->setCellValue('A1', 'SPPD');
		$objPHPExcel->getActiveSheet()->setCellValue('B1', 'NAMA 1');
		$objPHPExcel->getActiveSheet()->setCellValue('C1', 'NAMA 2');
		$objPHPExcel->getActiveSheet()->setCellValue('D1', 'ALAMAT 1');
		$objPHPExcel->getActiveSheet()->setCellValue('E1', 'ALAMAT 2');
		$objPHPExcel->getActiveSheet()->setCellValue('F1', 'SEQ NO');
		$objPHPExcel->getActiveSheet()->setCellValue('G1', 'JML SAHAM');
		$objPHPExcel->getActiveSheet()->setCellValue('H1', 'NO ACC 1');
		$objPHPExcel->getActiveSheet()->setCellValue('I1', 'PAYMENT CO');
		$objPHPExcel->getActiveSheet()->setCellValue('J1', 'GROSS');
		$objPHPExcel->getActiveSheet()->setCellValue('K1', 'PAJAK');
		$objPHPExcel->getActiveSheet()->setCellValue('L1', 'JENIS BAYAR');
		$objPHPExcel->getActiveSheet()->setCellValue('M1', 'YEAR');

		for ($j=1; $j<=$jmli;$j++) {
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(0, $j+1, $sppdi[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(1, $j+1, $nama1i[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(2, $j+1, $nama2i[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(3, $j+1, $alamat1i[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(4, $j+1, $alamat2i[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(5, $j+1, $seqnoi[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(6, $j+1, $jmlsahami[$j]);
			$objPHPExcel->getActiveSheet()->setCellValueExplicitByColumnAndRow(7, $j+1, $noacc1i[$j], PHPExcel_Cell_DataType::TYPE_STRING);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(8, $j+1, $paymentcoi[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(9, $j+1, $grossi[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(10, $j+1, $pajaki[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(11, $j+1, $jenisbayari[$j]);
			$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(12, $j+1, $yeari[$j]);
		}
        ...
        <tr height="20px"> 
            ...
            <td colspan="5" style="padding-left: auto; text-align: left; font-size: 12;">
				<div class="side-by-side clearfix">
					...
					(Nama / SPPD / Nomor Rekening / Nama Bank)
					</font>
				</div>
			</td>
		</tr>
	...
	<table align="left" style="text-align: left; margin-left: 30px; margin-right: auto; margin-top: auto;" width="500px" border="0" cellpadding="0" cellspacing="0">	
		...
		<tr height="25px"> 
            <td style="padding-left: auto; text-align: left; font-size: 12; width: 100px">
				<input type="checkbox" name="cbtunai" id="cbtunai" class="css-checkbox" <?php if ($cbtunai) echo "checked"?>/>
				<label for="cbtunai" class="css-label lite-blue-check"><font face="arial" size="2" color="black">Tunai</tunai></label>
			</td>
			<td colspan="2" style="padding-left: auto; text-align: left; font-size: 12; width: 100px">
				<input type="checkbox" name="cbtransfer" id="cbtransfer" class="css-checkbox" <?php if ($cbtransfer) echo "checked"?>/>
				<label for="cbtransfer" class="css-label lite-blue-check"><font face="arial" size="2" color="black">Transfer</font></label>
			</td>
        </tr>
		<tr height="10px">
            <td colspan="3" style="padding-left: auto; text-align: left; font-size: 12; width: 100px">
        ...
        <tr height="40px"> 
            ...
            <td style="padding-left: 60px; padding-top: auto; text-align: left; width: 200px">
<?php
	if ($levelidku==1) {
?>
...
?>
        ...
        <tr height="20px"> 
            <td colspan="3" style="padding-left: auto; padding-top: 30px; text-align: left; font-size: 12; height: 20px">
			</td>
        </tr>
    </table>
</form>
...
<table align="left" style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: 0px;" width="2300px" border="0" cellpadding="0" cellspacing="0">
		<tr height="40px"> 
            ...
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 230px">
				<b><i><font face="arial" size="2" color="black">NAMA 1</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 230px">
				<b><i><font face="arial" size="2" color="black">NAMA 2</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 130px">
				<b><i><font face="arial" size="2" color="black">SPPD</font></i></b>
			</td>
            ...
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 150px">
				<b><i><font face="arial" size="2" color="black">KOTA</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 50px">
				<b><i><font face="arial" size="2" color="black">SEQ_NO</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 100px">
				<b><i><font face="arial" size="2" color="black">NO REK</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 100px">
            ...
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 120px">
				<b><i><font face="arial" size="2" color="black">TAX</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 100px">
				<b><i><font face="arial" size="2" color="black">JENIS BAYAR</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 60px">
				<b><i><font face="arial" size="2" color="black">PAYMNT_CO</font></i></b>
			</td>
            <td style="padding-left: auto; text-align: center; font-size: 12; width: 60px">
				<b><i><font face="arial" size="2" color="black">TAHUN</font></i></b>
			</td>
          </tr>
<?php
...
?>
        <tr height="30"> 
            ...
            <td style="padding-left: 10px; text-align: left; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $nama1i[$i];?></font>
			</td>
            <td style="padding-left: 10px; text-align: left; font-size: 12;">
				<input type="hidden" id="returid" name="returid" value="<?php print $i;?>">
				<font face="arial" size="2" color="black"><?php print $nama2i[$i];?></font>
			</td>
            <td style="padding-right: 10px; text-align: center; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $sppdi[$i];?></font>
			</td>
            ...
            <td style="padding-right: 10px; text-align: center; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $kotai[$i];?></font>
			</td>
            <td style="padding-right: 10px; text-align: center; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $seqnoi[$i];?></font>
			</td>
            <td style="padding-right: 10px; text-align: right; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $noacc1i[$i];?></font>
			</td>
            <td style="padding-right: 10px; text-align: right; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $jmlsahami[$i];?></font>
			</td>
            <td style="padding-right: 10px; text-align: right; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $grossi[$i];?></font>
			</td>
            <td style="padding-right: 10px; text-align: right; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $pajaki[$i];?></font>
			</td>
            <td style="padding-right: 0px; text-align: center; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $jenisbayari[$i];?></font>
			</td>
            <td style="padding-right: 0px; text-align: center; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $paymentcoi[$i];?></font>
			</td>
            <td style="padding-right: 0px; text-align: center; font-size: 12;">
				<font face="arial" size="2" color="black"><?php print $yeari[$i];?></font>
			</td>
         </tr>
<?php
}
