...
<form action="viewdata.php" method="post" name="viewdata" id="viewdata">
	<table align="left" style="text-align: left; margin-left: 20px; margin-right: auto; margin-top: 0px;" width="500px" border="0" cellpadding="0" cellspacing="0">
		<tr height="60px">
	...
	<table align="left" style="text-align: center; margin-left: 30px; margin-right: auto; margin-top: 0px;" width="550px" border="0" cellpadding="0" cellspacing="0">
        <tr height="35px"> 
            ...
            <td width="70px" style="padding-left: auto; text-align: left; font-size: 12;">
				<div class="side-by-side clearfix">
					<select id="tahunbuku1" name="tahunbuku1" data-placeholder="Tahun Buku" style="width:80px;" class="chosen-select-deselect">
...
?>
			...
			<td width="30px" style="padding-left: auto; text-align: center; font-size: 12;">s/d</td>
            <td width="70px" style="padding-left: 0px; text-align: left;">
				<div class="side-by-side clearfix">
					<select id="tahunbuku2" name="tahunbuku2" data-placeholder="Tahun Buku" style="width:80px;" class="chosen-select-deselect">
						<option value="0">(All)</option>
<?php
						for ($i=2007;$i<=date('Y');$i++) {
?>
						<option value="<?php print $i;?>" <?php if ($i == $tahunbuku2) echo "selected";?>>
						<?php print $i;?>
						</option>
<?php
						}
?>
            ...
            <td width="35px" style="padding-left: 0px; text-align: left;">
					<font size="2" face="arial" color="black">
					<select id="batch2" name="batch2" data-placeholder="Batch" class="chosen-select-deselect" style="width:60px;" >
						<option value="0" <?php if ($batch1==0) echo "selected";?>>(All)</option>
						<option value="1" <?php if ($batch1==1) echo "selected";?>>1</option>
						<option value="2" <?php if ($batch1==2) echo "selected";?>>2</option>
						<option value="3" <?php if ($batch1==3) echo "selected";?>>3</option>
	...
	<br>
	<table align="left" style="text-align: left; margin-left: 30px; margin-right: auto; margin-top: auto;" width="600px" border="0" cellpadding="0" cellspacing="0">	
		<tr>
            <td colspan="3" style="padding-left: auto; text-align: left; font-size: 12; width: 500px">
				<hr noshade size=1>
			</td>
        </tr>
		<tr height="25px">
            <td style="padding-left: auto; text-align: left; font-size: 12; width: 100px">
				...
				<label for="cbtunai" class="css-label lite-blue-check"><font face="arial" size="2" color="black">Tunai</font></label>
			</td>
			<td style="padding-left: auto; text-align: left; font-size: 12; width: 100px">
			...
			<td style="padding-left: auto; text-align: left; font-size: 12; width: 200px">
			</td>
        </tr>
		<tr height="10px">
		...
		<tr height="25px"> 
            <td style="padding-left: auto; text-align: left; font-size: 12;">
				<input type="checkbox" name="cbpub" id="cbpub" class="css-checkbox" <?php if ($cbpub) echo "checked"?>/>
				<label for="cbpub" class="css-label lite-blue-check"><font face="arial" size="2" color="black">PUB</font></label>
			</td>
			<td style="padding-left: auto; text-align: left; font-size: 12;">
				<input type="checkbox" name="cbesa1" id="cbesa1" class="css-checkbox" <?php if ($cbesa1) echo "checked"?>/>
				<label for="cbesa1" class="css-label lite-blue-check"><font face="arial" size="2" color="black">ESA1</font></label>
			</td>
			<td style="padding-left: auto; text-align: left; font-size: 12;">
				<input type="checkbox" name="cbesa2" id="cbesa2" class="css-checkbox" <?php if ($cbesa2) echo "checked"?>/>
				<label for="cbesa2" class="css-label lite-blue-check"><font face="arial" size="2" color="black">ESA2</font></label>				
			</td>
        </tr>
		<tr height="10px">
            <td colspan="3" style="padding-left: auto; text-align: left; font-size: 12; width: 100px">
        ...
        <tr height="25px"> 
            <td colspan="3" style="padding-right: 10px; text-align: left; font-size: 12; width: 200px">
				<input type="checkbox" name="cbbni" id="cbbni" class="css-checkbox" <?php if ($cbbni) echo "checked"?>/>
				<label for="cbbni" class="css-label lite-blue-check"><font face="arial" size="2" color="black">Transfer ke BNI</font></label>
				&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="cblain" id="cblain" class="css-checkbox" <?php if ($cblain) echo "checked"?>/>
				<label for="cblain" class="css-label lite-blue-check"><font face="arial" size="2" color="black">Transfer ke Bank Lain</font></label>
				&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="cbscb" id="cbscb" class="css-checkbox" <?php if ($cbscb) echo "checked"?>/>
				<label for="cbscb" class="css-label lite-blue-check"><font face="arial" size="2" color="black">Transfer ke SCB</font></label>				
			</td>
        </tr>
		<tr height="10px">
            <td colspan="3" style="padding-left: auto; text-align: left; font-size: 12; width: 200px">
				<hr noshade size=1>
			</td>
        </tr>
        <tr height="25px"> 
            <td colspan="3" style="padding-right: 10px; text-align: left; font-size: 12;">
				<font face="arial" size="2" color="black">
				Status Pembayaran : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="cbselesai" id="cbselesai" class="css-checkbox" <?php if ($cbbni) echo "checked"?>/>
				<label for="cbselesai" class="css-label lite-blue-check"><font face="arial" size="2" color="black">Selesai</font></label>
				&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="cbretur" id="cbretur" class="css-checkbox" <?php if ($cblain) echo "checked"?>/>
				<label for="cbretur" class="css-label lite-blue-check"><font face="arial" size="2" color="black">Retur</font></label></font>
				&nbsp;&nbsp;&nbsp;
			</td>
        </tr>
		<tr height="10px">
        ...
        <tr height="30px"> 
            ...
            <td style="padding-left: 60px; padding-top: auto; text-align: left; width: 300px">
<?php
	if ($levelidku==1) {
?>
